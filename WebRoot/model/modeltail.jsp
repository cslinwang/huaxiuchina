...
<body>
	<form name="form" action="modelUpdate1?mid=${modeldetail.mid }&name=${user.name }" method="post">
		<div class=formzone>
			<DIV class=searchzone>
				<TABLE height=30 cellSpacing=0 cellPadding=0 width="100%" border=0>
					<TBODY>
						<TR>
							<TD height=30>模型修改</TD>
					...
					<TBODY>
						...
						<tr>
							...
							<td height="30"><input type="text" class="input"
								...
								value="${modeldetail.dm }"
								disabled ="true">
							</td>
						</tr>
						<tr>
							<td align=middle width=100 height=30>模型阶段</td>
						...
						<tr>
							<td align=middle width=100 height=30>均价</td>
							<td height="30"><input type="text" class="input"
								style="FONT-SIZE: 12px; WIDTH: 300px" name=price
								value="${modeldetail.price }">
							</td>
						</tr>
						<tr>
