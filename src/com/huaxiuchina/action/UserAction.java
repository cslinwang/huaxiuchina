...
public class UserAction implements ModelDriven<User> {
	...
	private UserDao serviceImp = (UserDao) ac.getBean("userDao");
	...
	public String userUpdate(){
		session.put("userdetail", (User)(serviceImp.selectById(user.getUid()).get(0)));
		return "userUpdate";
	}
	public String userUpdate1(){
		System.out.println(user.getName()+user.getPwd()+user.getType()+user.getUid());
